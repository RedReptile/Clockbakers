...
export const AuthForm = ({
    ...
    return (
        <div className={`w-full md:w-[500px] ${style} ${center ? "flex flex-col justify-center items-center" : "md:absolute md:left-[60px] md:top-[-20px]"} px-4`}>
            ...
            <form className="space-y-4 w-full" onSubmit={onSubmit}>
                ...
                <button type="submit" className="w-full h-[50px] bg-[#212121] rounded-lg mt-8 text-white font-bold hover:bg-[#F75186] transition duration-300">
                    {buttonText}
                </button>
            </form>
